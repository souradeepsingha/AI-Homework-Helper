...
class Homepage : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val shortcon =
            findViewById<LinearLayout>(R.id.shortcon) // Assuming shortcon is your LinearLayout ID

        shortcon.setOnClickListener {
            val intent = Intent(
                this,
                MainActivity::class.java
            ) // Change MainActivity to your desired activity
            intent.putExtra("SOME_KEY", "300")
            startActivity(intent)
            finish() // If you want to finish the current activity after navigating
        }
        val mediumcon =
            findViewById<LinearLayout>(R.id.mediumcontent) // Assuming shortcon is your LinearLayout ID
        ...
        val longcon =
            findViewById<LinearLayout>(R.id.longcon) // Assuming shortcon is your LinearLayout ID
        ...
        val customcon =
            findViewById<LinearLayout>(R.id.customcon) // Assuming shortcon is your LinearLayout ID
...
//
//            val appLink = "This is AI Question Solver App download the App. This is Link"+" https://play.google.com/store/apps/details?id=com.aiquestionsolver.user"
//
//            // Create the Intent
//
//            // Create the Intent
...
//            val appPackageName = "com.aiquestionsolver.user"
//            try {
